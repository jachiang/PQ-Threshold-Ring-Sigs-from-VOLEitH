...
const std::array<std::array<std::array<uint8_t, 32>, num_ctr_blocks>, num_keys> aes128_ctr_outputs = {{
...
const std::array<std::array<std::array<uint8_t, 32>, num_ctr_blocks>, num_keys> aes192_ctr_outputs = {{
...
const std::array<std::array<std::array<uint8_t, 32>, num_ctr_blocks>, num_keys> aes256_ctr_outputs = {{
...
TEST_CASE( "aes ctr", "[aes]" ) {
    ...
    // XXX: counter seems to be ignored
    ...
    for (size_t i = 0; i < num_keys; ++i) {
        ...
        memcpy(&expected_output[i * 16 * 4], &expected_aes_ctr_output[i], 16 * 4);
    }
