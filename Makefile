...
COMMON_LD_FLAGS ?= -Og -march=native -mtune=native -ggdb -fsanitize=address -fsanitize=undefined # Debug Slow # TODO: Use -O0 once all extern inline have been defined.
