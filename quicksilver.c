...
extern void quicksilver_verifier_init_key_0(const quicksilver_state* state, qs_verifier_key* in);
extern qs_prover_poly_deg1 qs_prover_poly_deg1_add_deg1(const quicksilver_state* state, const qs_prover_poly_deg1 left, const qs_prover_poly_deg1 right);
