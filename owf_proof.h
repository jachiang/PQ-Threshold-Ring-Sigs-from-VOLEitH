...
#define TAGGED_RING_WITNESS_BITS3 ((TAGGED_RING_PK_OWF_NUM + TAGGED_RING_TAG_OWF_NUM3) * (8 * OWF_BLOCKS * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1)) + OWF_KEY_WITNESS_BITS + FAEST_RING_HOTVECTOR_BYTES * 8)
