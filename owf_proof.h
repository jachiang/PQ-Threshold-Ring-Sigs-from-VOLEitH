...
#if defined(OWF_AES_CTR)
	#define CBC_TAGGED_RING_WITNESS_BITS (TAGGED_RING_PK_OWF_NUM * (8 * OWF_BLOCKS * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1)) + (CBC_TAGGED_RING_TAG_OWF_NUM - 1) * (8 * OWF_BLOCK_SIZE * OWF_ROUNDS) + (8 * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1)) + OWF_KEY_WITNESS_BITS + FAEST_RING_HOTVECTOR_BYTES * 8)
#endif
