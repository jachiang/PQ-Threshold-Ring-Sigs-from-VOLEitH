...
#define OWF_NUM_CONSTRAINTS4 (OWF_BLOCKS * OWF_CONSTRAINTS_PER_ROUND * OWF_ROUNDS * 2 + OWF_KEY_SCHEDULE_CONSTRAINTS)
#define WITNESS_BITS (8 * OWF_BLOCKS * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1) + OWF_KEY_WITNESS_BITS)
#define WITNESS_BITS4 (8 * OWF_BLOCKS * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1) * 2 + OWF_KEY_WITNESS_BITS)
...
// #define TAGGED_RING_TAG_OWF_NUM3 (2)
		...
		#define TAGGED_RING_TAG_OWF_NUM3 (3)
	#elif SECURITY_PARAM == 256
		#define TAGGED_RING_CBC_OWF_NUM (4)
		#define TAGGED_RING_TAG_OWF_NUM3 (4)
	#endif
#elif defined(OWF_RIJNDAEL_EVEN_MANSOUR)
...
#define CBC_TAGGED_RING_WITNESS_BITS ((TAGGED_RING_PK_OWF_NUM + 1) * (8 * OWF_BLOCKS * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1)) + (TAGGED_RING_CBC_OWF_NUM - 1) * (8 * OWF_BLOCKS * OWF_BLOCK_SIZE * OWF_ROUNDS) + OWF_KEY_WITNESS_BITS + FAEST_RING_HOTVECTOR_BYTES * 8)

#if defined(OWF_AES_CTR)
	#define TAGGED_RING_WITNESS_BITS3 (TAGGED_RING_PK_OWF_NUM * (8 * OWF_BLOCKS * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1)) + (TAGGED_RING_TAG_OWF_NUM3 - 1) * (8 * OWF_BLOCK_SIZE * OWF_ROUNDS) + (8 * OWF_BLOCK_SIZE * (OWF_ROUNDS - 1)) + OWF_KEY_WITNESS_BITS + FAEST_RING_HOTVECTOR_BYTES * 8)
#endif
