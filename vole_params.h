...
#define WITNESS_BLOCKS4 ((WITNESS_BITS4 + 128 * VOLE_BLOCK - 1) / (128 * VOLE_BLOCK))
...
#define TAGGED_RING_CBC_WITNESS_BLOCKS ((CBC_TAGGED_RING_WITNESS_BITS + 128 * VOLE_BLOCK - 1) / (128 * VOLE_BLOCK))
#if defined(OWF_AES_CTR)
	#define TAGGED_RING_WITNESS_BLOCKS3 ((CBC_TAGGED_RING_WITNESS_BITS + 128 * VOLE_BLOCK - 1) / (128 * VOLE_BLOCK))
#endif
