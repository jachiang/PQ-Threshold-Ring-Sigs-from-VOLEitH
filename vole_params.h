...
#define TAGGED_RING_CBC_WITNESS_BLOCKS ((TAGGED_RING_CBC_WITNESS_BITS + 128 * VOLE_BLOCK - 1) / (128 * VOLE_BLOCK))
#if defined(OWF_AES_CTR)
	#define TAGGED_RING_WITNESS_BLOCKS3 ((TAGGED_RING_WITNESS_BITS3 + 128 * VOLE_BLOCK - 1) / (128 * VOLE_BLOCK))
#endif
